...
public class AdventureGame {
    ...
    private static void firstChoice(){
        System.out.println("You are standing in a dark forest and you lost your flashlight. Do you want to go 'left' or 'right'? ");
        ...
        if(choice.equalsIgnoreCase("right")){
            ...
            firstChoice();//ask user the choice again
        }
    }

    private static void goLeft(){
        System.out.println("You encountered a wild river surrounded by killer wolves. Health:-100, Game Over :(");

    }

    private static void goRight(){
        System.out.println("You've found a small but dark hut, you go inside and fall through a trap door." + "\n" + "When you land you discover a small treasure box. Congrats you win! :) ");
    }
}
